...
//precondition: going to determine if two objects are equal to each other (multiple compelx numbers)
//postcondition: going to first do the real number to check with the second object real number, then for the imaginary number
...
//precondition: going to determine if the two objects are not equal, if not then false
//postcondition: 
bool operator!=(const Complex& obj1, const Complex& obj2){
	return (obj2.getRealNumber() != obj1.getRealNumber()) && (obj2.getImaginaryNumber() != obj1.getImaginaryNumber());
}
