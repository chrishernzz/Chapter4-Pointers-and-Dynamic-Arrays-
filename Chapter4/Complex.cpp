	...
	beginning:
		...
		case 'B': {
			do {
				...
				switch (optionAComp) {
				case 1: {
					multC1.setRealNumber(inputDouble("\n\t\t\tEnter a number (double value) for the real part C1: "));
					multC1.setImaginaryNumber(inputDouble("\t\t\tEnter a number (double value) for the imaginary part C1: "));
				...
				case 2: {
					...
					multC2.setImaginaryNumber(inputDouble("\t\t\tEnter a number (double value) for the imaginary part C1: "));
					cout << "\n\t\t\tC1 = " << multC2.getRealNumber() << " + " << multC2.getImaginaryNumber() << "i\n\n";
					system("pause");
					system("cls");
				}
					  break;
